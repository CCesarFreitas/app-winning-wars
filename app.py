...
from oauth2client.service_account import ServiceAccountCredentialsimport hashlib
import json
import random
import re
import time
...
# ==============================================================================
# PÁGINA EXCLUSIVA: NOVIDADES E PAINEL DE NOTÍCIAS (CORRIGIDA)
# ==============================================================================
def renderizar_pagina_novidades():
  ...
  if not df_novidades.empty:
    ...
    for _, item in novidades_inv.iterrows():
      ...
      # CORREÇÃO APLICADA AQUI (use_container_width + tratamento de erro de URL)
      if img_url:
        try:
