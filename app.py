...
st.markdown(
    ...
    /* ==========================================================
       WINNING WARS 3.6 - CORREÇÃO DE USABILIDADE MOBILE
       Evita movimento horizontal da página inteira.
       ========================================================== */
    ...
    /* O container principal não pode ultrapassar a viewport por padding/margens. */
    .main .block-container {
        padding-left: clamp(.65rem, 3vw, 2.2rem) !important;
        padding-right: clamp(.65rem, 3vw, 2.2rem) !important;
    }

    /* Colunas Streamlit podem manter min-width interno e empurrar a página. */
    ...
    /* Conteúdo de texto nunca deve obrigar o viewport a crescer. */
    ...
    /* Imagens e mídia ficam sempre dentro da tela. */
    img, video, canvas, svg {
        max-width: 100% !important;
        height: auto;
    }

    /* Componentes customizados/iframes não podem alargar a página principal. */
    iframe,
    ...
    /* Inputs e widgets nunca extrapolam a coluna no celular. */
    ...
    /* Tabs ficam contidas: se forem muitas, rolam dentro da própria faixa. */
    ...
    /* Dataframes e editores rolam internamente, nunca no body. */
    ...
    /* Topo / portais: garante que a largura total fique dentro da tela. */
    .st-key-top_nav_menu {
        width: 100% !important;
        max-width: 100% !important;
    ...
    .st-key-top_nav_menu .top-nav-link,
    ...
    /* Mobile: reduz espaçamentos que somados podem criar overflow. */
    @media (max-width: 768px) {
        .main .block-container {
        ...
        /* Nas três chamadas principais, evita texto forçando coluna larga. */
        .st-key-top_nav_menu div.stButton > button,
        .st-key-top_nav_menu .top-nav-link {
        ...
        /* Cards ficam um pouco mais compactos no telefone. */
        .news-card,
        .info-card,
        .rules-card {
        ...
        /* Evita que efeitos transformados criem uma caixa visual além do viewport. */
        .ww-logo-wrap,
        .ww-main-logo {
            max-width: 100% !important;
        }
